...
const services_contents = {
  ...
  subtitle: 'Why Choose Vuvu Properties',
  title: 'Value- adding and preferred real estate agent for both buyers and sellers of property in South Africa',
