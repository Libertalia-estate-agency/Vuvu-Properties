const blog_data = [
  {
    ...
    short_desc:"Highlighting the most promising areas for property investment based on current market trends.",
    duration:'.6s',
    delay:'.4s',
    home:true,
  },
  {
    ...
    short_desc:"Providing practical advice for renters, including lease agreements, budgeting, and tenant rights.",
    duration:'.7s',
    delay:'.6s',
    home:true,
  },
